  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="starter.php"><i class="fa fa-link"></i> <span>Overview</span></a></li>
        <li><a href="orders.php"><i class="fa fa-link"></i> <span>Orders</span></a></li>
		<li><a href="menu-editor.php"><i class="fa fa-link"></i> <span>Menu Editor</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
