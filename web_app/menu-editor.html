  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
		...
		<li  class="active"><a href="menu-editor.html"><i class="fa fa-link"></i> <span>Menu Editor</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
...
<table class="table table-striped table-bordered" id="apps">
                            ...
                            <tbody>
                                <tr id="1">
                                    ...
                                    <td class="tabledit-view-mode"><span class="tabledit-span"></span><input class="tabledit-input form-control input-sm" type="text" name="firstname" value="Celso" style="display: none;" disabled=""></td>
                                    ...
                                    <td class="tabledit-view-mode"><span class="tabledit-span"></span><input class="tabledit-input form-control input-sm" type="text" name="firstname" value="Márcio" style="display: none;" disabled=""></td>
